...
def test_rotate_camera_intrinsics_180_updates_principal_point() -> None:
    assert rotate_camera_intrinsics_180(
        width_px=1280,
        height_px=720,
        fx=1160.0,
        fy=1159.0,
        cx=649.7,
        cy=349.5,
    ) == pytest.approx((1160.0, 1159.0, 629.3, 369.5))
